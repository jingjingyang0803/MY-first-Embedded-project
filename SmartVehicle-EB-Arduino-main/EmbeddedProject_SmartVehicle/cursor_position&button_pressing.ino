// Create program that shows x-potentiometer value in analogue format, position of “I” on LCD follows the position of joystick 
// Activate ISR by pressing button
...
void loop() {
  ...
  cursorplace = x_value / 1023.0 * 20 - 1 == -1 ? 0 : x_value / 1023.0 * 20 - 1;
